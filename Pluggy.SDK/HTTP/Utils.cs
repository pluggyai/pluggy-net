...
namespace Pluggy.SDK.HTTP
{
    internal static class Utils
    {
        ...
        internal static Uri BuildUri(string baseUrl, string resource, IDictionary<string, string> urlSegments,
            IDictionary<string, string> queryStrings, bool includeEmptyParameters = false)
        {
        ...
        internal static IDictionary<string, string> GetSegment(string value, string key = "id")
        {
